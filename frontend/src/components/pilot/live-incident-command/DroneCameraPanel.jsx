...
export default function DroneCameraPanel({ selectedDrone, onMaximize, isMaximized = false, onExit }) {

const liveUrl = selectedDrone ? `http://43.205.31.167:4005/?stream=${selectedDrone}` : "";
