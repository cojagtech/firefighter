  ...
  const fetchAlert = async () => {
    try {
      ...
      const res = await fetch(
        `${API_BASE}/fire-fighter/live-incident-command/get_latest_detection.php?droneId=${selectedDrone}&t=${Date.now()}`
      );
      ...
      // only update when new detection comes
